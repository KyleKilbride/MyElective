			...
			<div class="container">		
				...
				<% if(session.getAttribute("adminAction")=="editElective"){%>			
					...
					<form action="adminServlet" method="POST">		
						<b><fmt:message key="admin.label.electivename" />:</b> <%=elective.getName()%> <input style="color:black" type="text" name="editElectiveNewName" size="50" maxlength="200" placeholder="<fmt:message key="admin.label.newelectivename" />"/>
						<input type="submit" class="btn-default" value="<fmt:message key="admin.button.submitnewname" />"/>
						<input hidden="true" type="text" name="editElectiveCurrentName" value="<%=elective.getName()%>" style="color:black"/>
					</form>
					<br/><br/>
					<form action="adminServlet" method="POST">
						<b><fmt:message key="admin.label.electivecode" />:</b> <%=elective.getCourseCode()%> <input style="color:black" type="text" name="editElectiveNewCode" maxlength="8" placeholder="<fmt:message key="admin.label.newelectivecode" />"/>
						<input type="submit" class="btn-default" value="<fmt:message key="admin.button.submitcoursecode" />"></input>
						<input hidden="true" type="text" name="editElectiveCurrentCode" value="<%=elective.getCourseCode()%>" style="color:black"/>
					</form>
					<br/><br/>
					<form action="adminServlet" method="POST" id="editElectivesDescForm">	
						...
						<br/><br/>
						<textarea style="color:black" name="editElectiveNewDesc" placeholder="<fmt:message key="admin.label.newelectivedescription" />" form="editElectivesDescForm" rows="5" cols="75" maxlength="5000"></textarea>
						<br/></br>
						<input type="submit" class="btn-default" value="<fmt:message key="admin.button.submitnewdescription" />"></input>
						<input style="color:black" hidden="true" type="text" name="editElectiveCurrentDesc" value="<%=elective.getDescription()%>"/>
					</form>
						<%}%>			
					<%}%>
					<%if(session.getAttribute("adminAction")=="removeElective"){%>
						...
						<form action="" method="POST">		
							...
							<input type="submit" class="btn-default" value="<fmt:message key="admin.button.removeelective" />"></input>			
						</form>
						...
						<form action="adminServlet" method="POST">	
							...
							<br/>	
							<b><fmt:message key="admin.label.confirmremove" />: </b><input style="color:black" type="text" maxlength="7" name="removeElectiveConfirm" placeholder="<fmt:message key="admin.label.sure" />"/>
							<input type="submit" class="btn-default" value="<fmt:message key="admin.label.confirmremove" />" />
							<input style="color:black" hidden="true" type="text" name="removeElectiveName" value="<%=elective.getName()%>"/>
						</form>
							<%}%>
					<%}%>
					<%if(session.getAttribute("adminAction")=="addElective"){%>
						...
						<form action="adminServlet" method="POST" id="addElectivesForm">
							<b><fmt:message key="admin.label.electivename" />: </b><input style="color:black" type="text" name="addElectiveName" maxlength="200" placeholder="<fmt:message key="admin.label.electivename" />"/>
							<br/><br/>
							<b><fmt:message key="admin.label.electivecode" />: </b><input style="color:black" type="text" name="addElectiveCode" maxlength="8" placeholder="<fmt:message key="admin.label.electivecode" />"/>
							<br/><br/>
							<b><fmt:message key="admin.label.electivedescription" />: </b><textarea style="color:black" name="addElectiveDesc" maxlength="5000" placeholder="<fmt:message key="admin.label.electivedescription" />" form="addElectivesForm" rows="5" cols="75"></textarea>
							<br/><br/>
